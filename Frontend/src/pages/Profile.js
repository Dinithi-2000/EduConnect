...
export default function Profile() {
  ...
  return (
    <DashboardLayout activeSection="Settings" theme={isAdminView ? 'dark' : 'light'}>
      <div className={`container kuppi-page kuppi-page-space profile-page ${isAdminView ? 'admin-profile-theme' : ''}`}>
